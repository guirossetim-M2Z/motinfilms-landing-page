...
export function CallToAction() {
  ...
  return (
    <section className="relative py-20 md:py-32 px-4 bg-[#020202] text-white overflow-hidden flex flex-col items-center justify-center min-h-[600px]">
      ...
      {/* CONTAINER PADRONIZADO (max-w-7xl) para o grid, mas texto centralizado */}
      <div className="container mx-auto max-w-7xl px-4 md:px-8 relative z-20 text-center">
        ...
        <motion.div
          ...
          className="relative group inline-block w-full md:w-auto px-0"
        >
